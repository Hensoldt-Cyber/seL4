...
if(KernelPlatformQEMUArmVirt)
    ...
    # Run QEMU to get the device tree binary. For some reason, this prints a
    # message to stderr and not stdout, so we capture it and then print it to
    # stdout to avoid polluting stderr unnecessarily.
    execute_process(
        COMMAND
