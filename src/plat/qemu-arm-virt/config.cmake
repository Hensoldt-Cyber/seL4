...
if(KernelPlatformQEMUArmVirt)
    ...
    # Unless QEMU_DTS or QEMU_DTB is set explicitly, the device tree is
    # extracted from QEMU. This keeps it nicely up to date with the actual QEMU
    # version in use  and is quite convenient during development.
    if(NOT DEFINED QEMU_DTS)
        ...
        if(error)
            message(FATAL_ERROR "Failed to create DTS from QEMU's DTB: ${QEMU_DTB}")
        endif()
