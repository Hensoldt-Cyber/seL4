...
)
{
    ...
    word_t extra_bi_size = populate_extra_bi(0, vbe, acpi_rsdp, fb_info, mb_mmap, tsc_freq);
    ...
    (void)populate_extra_bi(extra_bi_size, vbe, acpi_rsdp, fb_info, mb_mmap, tsc_freq);
